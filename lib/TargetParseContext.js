...
function _asPercent( numerator, denominator, deferred ) {
  ...
  for( var k in numerator.seriesList ) {
    for( var i in numerator.seriesList[k].data.values ) {
      ...
      if( typeof(numerator.seriesList[k].data.values[i]) != 'undefined' && numerator.seriesList[k].data.values[i] != null ) {
        var denom= denominatorFunc(i);
        if( typeof(denom) == 'undefined' || denom == null ) {
                ...
                for( var i=0;i<seriesLen;i++) {
                  var divisor= 0;
                    for( var k= 0; k< seriesCount;k++) {
                      if( typeof(populatedMetric.seriesList[k].data.values[i])!='undefined' && populatedMetric.seriesList[k].data.values[i] != null ) {
...
TargetParseContext.prototype.scale= function ( pa , pfactor ) {
	return this._simpleFactorApplication( pa, pfactor, "scale", function(v, f) { if(v != null && typeof(v) != 'undefined') return v * f; else return v;} );
}

TargetParseContext.prototype.offset= function ( pa , pfactor ) {
	return this._simpleFactorApplication( pa, pfactor, "offset", function(v, f) { if(v != null && typeof(v) != 'undefined') return v + f; else return v;} );
}
...
function sum(values) {
  var acc =0;
  for( var i in values) {
    if( values[i] != null && typeof(values[i]) !='undefined' ) acc += values[i];
  }
  return acc;
}
...
TargetParseContext.prototype.removeAboveValue= function ( pa , pn ) {
  return this._simpleFactorApplication( pa, pn, "removeAboveValue", function(v, f) { if(v != null && typeof(v) != 'undefined' && v > f) return null; else return v;} );
}

TargetParseContext.prototype.removeBelowValue= function( pa, pn ) {
  return this._simpleFactorApplication( pa, pn, "removeBelowValue", function(v, f) { if(v != null && typeof(v) != 'undefined' && v < f) return null; else return v;} );
}
      ...
      that.$chkSeries( value, true ).then( function( populatedMetric ) {
        ...
        for( var i=0; i < populatedMetric.seriesList.length; i++ ) {
          ...
          if( consecutiveNones > 0 && consecutiveNones < limit ) {
            ...
            if(typeof(backfillVal) != 'undefined' || backfillVal != null) {
