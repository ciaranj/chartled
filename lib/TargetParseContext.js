...
TargetParseContext.prototype.scale= function ( pa , pfactor ) {
	return this._simpleFactorApplication( pa, pfactor, "scale", function(v, f) { if(!isNone(v)) return v * f; else return v;} );
}

TargetParseContext.prototype.offset= function ( pa , pfactor ) {
	return this._simpleFactorApplication( pa, pfactor, "offset", function(v, f) { if(!isNone(v)) return v + f; else return v;} );
}
...
TargetParseContext.prototype.removeAboveValue= function ( pa , pn ) {
  return this._simpleFactorApplication( pa, pn, "removeAboveValue", function(v, f) { if(!isNone(v) && v > f) return null; else return v;} );
}

TargetParseContext.prototype.removeBelowValue= function( pa, pn ) {
  return this._simpleFactorApplication( pa, pn, "removeBelowValue", function(v, f) { if(!isNone(v) && v < f) return null; else return v;} );
}
